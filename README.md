...
## Zacharie Menetrier and Martin Mestdagh
...
Une fois cette installation terminé vous devez installer les outils nécéssaires avec:  
	`make install-tools`  
...
### Conclusion
Les logo nécéssaires à la conclusion sont situés dans /data/logo/ triés par classes.  
